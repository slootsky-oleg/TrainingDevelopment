...
using Bks.Fox.Behaviors.ResourceRequirements.Presentation.Controllers;
...
{
    [ApiController]
    [Route("training-development/tasks/{id:guid}/resource-requirements")]
    [FeatureGate(FeatureFlag.Task)]
    public class TaskResourceRequirementController : ResourceRequirementController<TrainingTask>
    {
        // [HttpPost]
